...
# Stock research workflow removed - not needed for Job Portal project
"""
...
MONGODB_DB = os.getenv("MONGODB_DB", "jobportal")
...
# =============================================================================
#                     REMOVED: TRAVEL PLANNER ENDPOINT
# =============================================================================
# Travel planner was from Smart Stay project and is not needed for Job Portal.
# Removed to keep the codebase focused on job matching and interview preparation.


# =============================================================================
#                     REMOVED: SOLO TRIP & STOCK RESEARCH ENDPOINTS
# =============================================================================
# These features were from Sigma GPT project and are not needed for Job Portal.
# Removed to keep the codebase focused on job matching and interview preparation.
...
def run_smart_chat(
    ...
    if force_tool:
        ...
        if force_tool == "search":
            ...
            # Stock research removed - not needed for Job Portal project
            raise HTTPException(status_code=503, detail="Stock research feature not available")
    ...
    # STOCK and SOLO_TRIP intents removed - not needed for Job Portal project
    # These features were from Sigma GPT project
    
    # TRAVEL intent removed - not needed for Job Portal project
    # Travel planning was from Smart Stay project
...
def _save_to_thread_checkpointer(thread_id: str, query: str, answer: str):
    ...
    ------------------------
    - (STOCK intent removed - not needed for Job Portal)
